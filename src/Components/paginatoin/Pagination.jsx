    ...
    return (
        <>  
          <div className='flex gap-4'>
            ...
            <div className={`border cursor-pointer w-7 h-7 rounded-md text-black  ${currentPage !== npage ? "text-[#a8a8a8]": ""} flex justify-center items-center`} onClick={prevPage}>
                <IoMdArrowDropleft  />
            </div>
            ...
            <div className={`border cursor-pointer w-7 h-7 rounded-md text-black ${currentPage == npage ? "text-[#a8a8a8]": ""} flex justify-center items-center`} onClick={nextPage}>
                <IoMdArrowDropright  />
            </div>
