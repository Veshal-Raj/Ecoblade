...
const CompletedService = () => {
  ...
  console.log(
    '🚀 ~ file: CompletedService.jsx:12 ~ CompletedService ~ bookingObjId:',
    bookingObjId
  );
    ...
    const fetchDataById = async () => {
      try {
        const responce = await axios.post(
          'https://qdn2l2ng-5050.inc1.devtunnels.ms/app/admin/completedAppointmentListById',
          requestData
        );
