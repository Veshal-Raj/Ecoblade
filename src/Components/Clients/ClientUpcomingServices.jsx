...
const ClientUpcomingServices = () => {
    ...
    const bookingId = localStorage.getItem('upcoming_bookingObjectId');
    const requestData = {
            ...
            <Wrapper title={"Upcoming Service"}>
                ...
                <div className="relative overflow-x-auto bg-white scrollbar-thumb-[#c7d6df] scrollbar-thin scrollbar-track-gray-100 xl:h-[calc(100vh-180px)] h-[calc(100vh-100px)] xl:pb-0 pb-5 no-scrollbar shadow-sm rounded-bl-[10px] rounded-br-[10px]">
                    <div className=' border-b py-4 px-10 flex justify-between items-center'>
                        ...
                        <button onClick={handleNaviaget} className='border-2 border-[#4ab500] rounded-lg px-4 py-2 text-[10px] flex  items-center gap-2 text-[#4ab500] font-semibold' ><BsChatLeftText size={15} style={{ color: "#4ab500" }} /> Chat Now</button>
                    </div>
                    <div className='p-10 xl:flex justify-between xl:gap-7'>
                        ...
                        <div className="flex flex-col w-full">
                            ...
                            <input
                                className="py-3 border   rounded-md border-[#CCCCCC] bg-white relative p mt-2 outline-none pl-3 text-gray-700 "
                                type="text"
                                // value={getData?.bookingOn}
                                value={formatTimestamp(getData?.bookingOn)}
                                placeholder="Title here"
                            />
                        </div>
                        ...
                        <div className="flex flex-col w-full">
                            ...
                            <input
                                ...
                                value={formatTimestamp(getData?.scheduledOn)}
                                placeholder="Title here"
                            />
                        </div>
                    </div>
                    ...
                    <div className='px-10 flex justify-end items-center'>
                        <button className="csm:w-48 w-28 rounded-lg csm:h-12 h-8 bg-[#4ab500] flex justify-center items-center gap-1"
                            onClick={handleCompleteService}
                        >
                            <p className="sm:text-base text-xs font-semibold text-white">Complete Service</p>
                        </button>
                    </div>
                    ...
                    <motion.div
                        ...
                        <div className="flex items-center min-h-screen  px-4 py-8">
                            <div className="relative w-full max-w-xl  py-4 p-2 mx-auto bg-white rounded-md shadow-lg ">
                                <div className='absolute right-8 top-5 text-lg text-gray-400 cursor-pointer' onClick={() =>
                                ...
                                <div className="mt-2 sm:flex flex-col">
                                    <div className="mt- text-cente sm:ml-4 sm:text-left">
                                        ...
                                        <div className='  -mt-2 md:pr-3.5'>
                                            ...
                                            <textarea className='w-full border rounded-lg h-20 text-sm p-4 mt-2 '
                                                ...
                                                {selectedLabels.map((label, index) => (
                                                    ...
                                                    >
                                                        <div className="w-full h-full flex flex-col items-center justify-center">
                                                            {label ? (
                                                                <img src={URL.createObjectURL(label)} alt={`Selected Image ${index}`} className="w-full h-full object-cover rounded-xl" />
                                                            ) : (
...
export default ClientUpcomingServices